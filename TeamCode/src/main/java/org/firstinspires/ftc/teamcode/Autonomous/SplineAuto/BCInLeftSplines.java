        ...
        switch (detection) {
            case LEFT -> drive.followTrajectorySequence(
                    drive.trajectorySequenceBuilder(new Pose2d(15.01, 62.69, Math.toRadians(90.00)))
                            ...
                            .waitSeconds(.5)
                            .splineToLinearHeading(new Pose2d(55.18, 48.07, Math.toRadians(180.00)), Math.toRadians(0.0))
                            .waitSeconds(.1)
            ...
            case CENTER -> { drive.followTrajectorySequence(
                    drive.trajectorySequenceBuilder(new Pose2d(15.01, 62.69, Math.toRadians(90.00)))
                            ...
                            .addTemporalMarker(() -> passiveServo.setPosition(0.2))
                            .waitSeconds(.5)
                            .splineToLinearHeading(new Pose2d(55, 41.46, Math.toRadians(180.00)), Math.toRadians(0.00))
                            .waitSeconds(.1)
                            .addTemporalMarker(() -> autoServo.setPosition(servoPlacePosition))
                            .waitSeconds(2)
                            .addTemporalMarker(() -> autoServo.setPosition(servoMidPosition))

...
//    ServoController getController();
     ...
     */
    void setDirection(Direction direction) {CURRENT_DIRECTION = direction;}
     ...
     */
    void setPosition(double position) {POSITION = position;}
     ...
     * @see #setPosition(double)
     */
    void scaleRange(double min, double max) {System.out.println("No you fucking shit");}
}
